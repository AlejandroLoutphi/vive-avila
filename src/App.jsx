...
export const firebaseContactMessagesCollection = collection(
  firebaseDb,
  "contactMessages"
);
  ...
  return (
    <nav className="navbar">
      ...
      <div className={`nav-links ${isOpen ? "open" : ""}`}>
        <a className="nav-item" onClick={() => setPage(Page.start)}>
          Inicio
        </a>
        <a className="nav-item" onClick={() => setPage(Page.blogGuide)}>
          Guía
        </a>
        <a className="nav-item" onClick={() => setPage(Page.excursiones)}>
          Excursiones
        </a>
        <a className="nav-item" onClick={() => setPage(Page.start)}>
          Foro
        </a>
        <a className="nav-item" onClick={() => setPage(Page.aboutUs)}>
          Sobre Nosotros
        </a>
        {user ? (
          <div className="nav-dropdown-container">
            ...
            <div className="nav-dropdown">
              ...
              {!user.provider && (
                <a className="nav-item" onClick={() => setPage(Page.editProfile)}>
                  Editar Perfil
                </a>
              )}
              <a
          ...
          <a className="nav-item" onClick={() => setPage(Page.login)}>
            Iniciar Sesión
          </a>
        )}
      </div>
