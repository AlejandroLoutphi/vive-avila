                    ...
                    <div className="start_activities-column">
                        ...
                        <div className="start_info-card">
                            ...
                            <p className="start_info-description">
                                El parque nacional El Ávila, oficialmente Waraira Repano, es un <a href="https://es.wikipedia.org/wiki/Parque_nacional" target="_blank" rel="noopener noreferrer">
                                    parque nacional</a> localizado en la Cadena del Litoral dentro de la <a href="https://es.wikipedia.org/wiki/Cordillera_de_la_Costa_(Venezuela)" target="_blank" rel="noopener noreferrer">
                                    cordillera de la Costa</a>, en el centro-norte de <a href="https://es.wikipedia.org/wiki/Venezuela" target="_blank" rel="noopener noreferrer">
                                    Venezuela</a>
                                . Se extiende desde <a href="https://es.wikipedia.org/wiki/Caracas" target="_blank" rel="noopener noreferrer">
                                    Caracas</a> (<a href="https://es.wikipedia.org/wiki/Distrito_Capital" target="_blank" rel="noopener noreferrer">Distrito Capital</a>
                                ), y todo el norte del <a href="https://es.wikipedia.org/wiki/Estado_Miranda" target="_blank" rel="noopener noreferrer">
                                    estado Miranda</a> y sur del <a href="https://es.wikipedia.org/wiki/Estado_La_Guaira" target="_blank" rel="noopener noreferrer">
                                    estado La Guaira</a>
                                .
                            </p>
